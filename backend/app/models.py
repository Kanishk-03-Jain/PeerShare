...
class User(Base):
    ...
    active_peers = relationship(
        "ActivePeer", back_populates="user", cascade="all, delete-orphan"
    )
...
class File(Base):
    ...
    # Relationship
    peer_holding = relationship(
        "ActivePeer", back_populates="file", cascade="all, delete-orphan"
    )
